...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchContent(page) {
        ...
        try {
            ...
            console.error(`10. Error in fetchContent(${page}):`, err);
            throw err;
        }
    }
    ...
    function initializePage(page) {
        ...
        try {
            ...
            console.error(`13. Error initializing page ${page}:`, err);
            mainContent.innerHTML = `<p>Error initializing ${page} page.</p>`;
        }
    }
    ...
    function initializeAbout() {
        ...
        console.log("15. Fetching testimonials from Firestore");
